    ...
    <div class="row">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
                  ...
                  {{-- <div class="form-group col-md-6">
                    <label>الخصم </label>
                    <input type="number"  value="{{$editem->discountprice}}" name="discount" class="form-control" placeholder = 'ادخل الخصم' >
                  ...
                  <div class="form-group col-md-12">
                      ...
                      <div style="padding: 2%;" class="col-md-3">
                          <img class="img-thumbnail" style="width:100%; height:10%;" src="{{asset('users/images/'.$editem->image)}}" alt="">
                      </div>
